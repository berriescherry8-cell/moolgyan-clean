...
-- Drop all existing admin-related functions and triggers
...
-- Delete all authentication users (this will force logout everyone)
...
-- CLEANUP COMPLETE
-- =====================================================
-- Now run the SETUP_NEW_ADMIN_SYSTEM_FIXED.sql script
