...
export default function BookOrderForm() {
  ...
  useEffect(() => {
    ...
    fetchBook();
  }, [params.bookId, supabase, toast, router]);
    ...
    return (
      <div className="container mx-auto p-6">
        <Card className="border-red-500/20 bg-red-500/10">
          <CardHeader>
            <CardTitle className="text-red-500">Book Not Found</CardTitle>
          </CardHeader>
          <CardContent>
            <p>The requested book could not be found. Please go back to the books page.</p>
  ...
  return (
    <div className="container mx-auto p-6 max-w-4xl">
      <div className="mb-6">
        <h1 className="text-3xl font-bold text-center mb-2">Book Order Form</h1>
        <p className="text-center text-zinc-400">Complete your order for {book.title}</p>
      </div>
