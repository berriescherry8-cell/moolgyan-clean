...
export default function SaarSangrahPage() {
  ...
  if (loading) return <div className="text-center py-20">Loading Saar Sangrah photos...</div>;
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto">
      <div className="flex items-center gap-4 mb-8">
        ...
        <h1 className="text-4xl font-bold">Saar Sangrah</h1>
      </div>
            ...
            <div className="relative w-full h-full flex flex-col">
              ...
              <div className="flex-1 flex items-center justify-center p-8">
                <Image
                  ...
                  alt={photos[currentIndex].file_name || 'Saar Sangrah'}
                  fill
