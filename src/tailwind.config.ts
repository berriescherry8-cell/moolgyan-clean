  ...
  theme: {
    ...
    extend: {
      fontFamily: {
        ...
        code: ["monospace"],
        numeric: ["var(--font-sans)", "sans-serif"],
      },
      colors: {
      ...
      keyframes: {
        ...
        'breathing': {
          '0%, 100%': { transform: 'translateY(0)', boxShadow: '0 10px 20px -5px hsl(var(--primary) / 0.1)' },
          '50%': { transform: 'translateY(-4px)', boxShadow: '0 20px 30px -5px hsl(var(--primary) / 0.2)' },
        },
        'shine': {
