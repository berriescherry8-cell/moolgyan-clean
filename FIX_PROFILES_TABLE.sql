-- ========================================
-- FIX PROFILES TABLE CONFLICT
-- ========================================
-- This script handles the case where profiles table already exists but might have different structure

-- Check if profiles table exists and has the correct structure
DO $$
BEGIN
    -- Check if profiles table exists and has the correct columns
    IF EXISTS (
